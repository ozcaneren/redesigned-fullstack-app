                      ...
                      <div className="flex justify-center items-center space-x-3">
                        <div className="mb-4">
                          ...
                          <input
                            ...
                            onChange={handleChange}
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-modalLabelText leading-tight focus:outline-none focus:shadow-outline resize-none"
                          ></input>
                        </div>
                        <div className="mb-4">
                          <label
                            className="block text-center text-modalLabelText text-sm font-bold mb-2"
                            htmlFor="cardText_en"
                          >
                            İngilizce
                          </label>
