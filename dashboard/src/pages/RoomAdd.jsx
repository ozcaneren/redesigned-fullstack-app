...
const RoomAdd = () => {
  ...
  const handleSubmit_en = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "http://localhost:4000/api/room/english",
        newEnglishRoom
      );
      navigate("/room");
      setRoomType_en("");
        ...
        <div className="flex justify-center items-center">
          <div className="w-full flex justify-center">
            <div className="w-full px-4 relative">
              ...
              >
                {languageMode ? "Türkçe Oda Ekle" : "Ingilizce Oda Ekle"}
              </button>
            </div>
          </div>
        </div>
                    ...
                    <form onSubmit={handleSubmit_en}>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setRoomDescription_en(e.target.value)
                          }
                          className="mt-1 p-2 w-full bg-white border-gray-300 border rounded-sm"
                        />
                      </div>
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setRoomShortDescription_en(e.target.value)
                          }
                          className="mt-1 p-2 w-full bg-white border-gray-300 border rounded-sm"
                        />
                      </div>
